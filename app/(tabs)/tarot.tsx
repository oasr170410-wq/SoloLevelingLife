    ...
    <ScrollView style={s.screen} contentContainerStyle={s.content}>
      ...
      {!dungeon ? (
        ...
        <View style={s.dungeonCard}>
          ...
          <Text style={s.sectionTitle}>Quests bonus</Text>
          {quests.map((q: string, i: number) => (
            <TouchableOpacity
              key={i}
              style={s.questBonus}
          ...
          <View style={s.xpBonusRow}>
            <Text style={s.xpBonusTag}>Dungeon completo: +{xpBonus} XP</Text>
          </View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={s.openBtnText}>Sacar otra carta</Text>
          </TouchableOpacity>
        </View>
      )}
...
const s = StyleSheet.create({
  ...
  dungeonMeaning: { color: '#6b6480', fontSize: 12, textAlign: 'center', lineHeight: 20, marginBottom: 16, paddingHorizontal: 8 },
  ...
  xpBonusRow:     { alignItems: 'center', marginTop: 12 },
  xpBonusTag:     { backgroundColor: '#26215C', color: '#AFA9EC', fontSize: 11, fontWeight: '500', paddingHorizontal: 14, paddingVertical: 5, borderRadius: 20 },
});